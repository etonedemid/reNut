...
extern "C" PPC_FUNC(sub_82CA25A0);
extern "C" PPC_FUNC(sub_82CA2A78);

PPC_FUNC_IMPL(sub_823A6950) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	PPCVRegister vTemp{};
	uint32_t ea{};
	...
	simde_mm_store_si128((simde__m128i*)ctx.v10.u8, rex::simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v10.u8), simde_mm_load_si128((simde__m128i*)ctx.v10.u8), simde_mm_load_si128((simde__m128i*)ctx.v4.u8)));
	// vor128 v24,v58,v58
	...
	// vperm v9,v2,v10,v3
	simde_mm_store_si128((simde__m128i*)ctx.v9.u8, rex::simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v2.u8), simde_mm_load_si128((simde__m128i*)ctx.v10.u8), simde_mm_load_si128((simde__m128i*)ctx.v3.u8)));
	...
	simde_mm_store_si128((simde__m128i*)ctx.v10.u8, rex::simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v10.u8), simde_mm_load_si128((simde__m128i*)ctx.v10.u8), simde_mm_load_si128((simde__m128i*)ctx.v5.u8)));
	// vsel v4,v4,v18,v3
	...
	// vperm v10,v4,v10,v2
	simde_mm_store_si128((simde__m128i*)ctx.v10.u8, rex::simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v4.u8), simde_mm_load_si128((simde__m128i*)ctx.v10.u8), simde_mm_load_si128((simde__m128i*)ctx.v2.u8)));
	// addi r9,r1,144
